...
function loadCustomMedia() {
  ...
  var customsubtitleURL = document.getElementById('customSubtitleURL').value;
  if (customMediaURL.length > 0) {
    loadMedia(customMediaURL, customSubtitleURL);
  }
...
function loadMedia(mediaURL, subtitleURL) {
  ...
  chrome.cast.media.TrackType.TEXT);
      englishSubtitle.trackContentId = subtitleURL;
      englishSubtitle.trackContentType = 'text/srt';
